 ...
 *
 */
public class FindNumberOfWaysToTraverseGraph {
    public static void main(String[] args) {
        ...
        System.out.println("With max 1 hops : "+new FindNumberOfWaysToTraverseGraph().run(nodeA,nodeC,1));
        System.out.println("With max 2 hops : "+new FindNumberOfWaysToTraverseGraph().run(nodeA,nodeC,2));
        System.out.println("With max 3 hops : "+new FindNumberOfWaysToTraverseGraph().run(nodeA,nodeC,3));

        //(A->B->C), (A->C), (A->C-A->C), (A->B->C->A->B), (A->C->A->B->C)
        System.out.println("With max 4 hops : "+new FindNumberOfWaysToTraverseGraph().run(nodeA,nodeC,4));
